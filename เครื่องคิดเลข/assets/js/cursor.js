/* ============================================
   ...
   สองชั้น: จุดเล็กตามติดแทบทันที + วงแหวนตามช้ากว่า
...
(function (w) {
  ...
  IM.register('cursor', function () {
    ...
    // ตำแหน่งที่ผ่าน damp แล้ว (คนละ lambda กัน จึงเก็บแยกจาก IM.pointer)
    ...
    function tick(dt) {
      ...
      /* --- เคอร์เซอร์ --- */
      dx = IM.damp(dx, px, 34, dt);      // จุดเล็ก: ตามแทบติดมือ
      dy = IM.damp(dy, py, 34, dt);
